...
class Bestsellers extends \Vortex\Merchandising\Block\Catalog\Product\Merchandising\ListMerchandising {

    protected $_configPath = 'bestsellers';


    /**
     * Initialise the product collection
     *
     * @return $this
     */
