 ...
 *
 */
namespace Vortex\Merchandising\Controller\Highestrated;

class Index extends \Vortex\Merchandising\Controller\MerchandisingAbstract
{

    public function execute()
    {
        $highestratedPage = $this->_resultPageFactory->create();
        $highestratedPage->getConfig()->getTitle()->set(__('Highestrated'));
        return $highestratedPage;
    }
}