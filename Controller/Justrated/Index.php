 ...
 *
 */
namespace Vortex\Merchandising\Controller\Justrated;
...
class Index extends \Vortex\Merchandising\Controller\MerchandisingAbstract
{
    ...
    {
        $justratedPage = $this->_resultPageFactory->create();
        $justratedPage->getConfig()->getTitle()->set(__('Justrated'));
        return $justratedPage;
    }
}
