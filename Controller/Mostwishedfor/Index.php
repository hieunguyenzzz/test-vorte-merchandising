 ...
 *
 */
namespace Vortex\Merchandising\Controller\Mostwishedfor;
...
class Index extends \Vortex\Merchandising\Controller\MerchandisingAbstract
{
    ...
    {
        $wishedforPage = $this->_resultPageFactory->create();
        $wishedforPage->getConfig()->getTitle()->set(__('Most Wished For'));
        return $wishedforPage;
    }
}
